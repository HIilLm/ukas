                        ...
                        <form action="{{ route('uangkas.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="number" min="500" step="500" name="byr_perminggu" class="form-control"
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <br>
                                <a href="{{ route('uangkas.show', ['uangka' => $item->id]) }}" {{-- /detail/februari --}}
                                        class="btn btn-primary btn-sm"><i data-feather="eye"></i></a>
                                @can('bendahara')
                                <form id="form-delete{{ $item->id }}"
                                    action="{{ route('uangkas.destroy', ['uangka' => $item->id]) }}" method="post"
                                    style="display: none">
                                    @method('delete')
                                    @csrf
                                </form>
                                    <span><a onclick="what({{ $item->id }})" style="cursor: pointer" href="#"
                                            class="btn btn-danger btn-sm"><i data-feather="trash-2"></i></a></span>
                                @endcan
                                </p>
                            </div>
                        </div>
